...
public interface ClienteInterface {
     ...
     * @return restituisce la stringa "pagamento accettato" se il pagamneto &egrave; andato a buon fine, mentre
     * se non &egrave; andato a buon fine restituisce la stringa "pagamento rifiutato".
     */
    String inviaPagamento(Carrello carrello);
     ...
     */
    List<Prodotto> cercaProdotto(String nomeProdotto);
